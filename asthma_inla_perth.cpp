...
Type objective_function<Type>::operator() ()
{
  ...
  matrix<Type> pollution_expanded(N_SA1_perth,N_pollution);
  vector<Type> buffer(N_SA1_perth);
  ...
  vector<Type> pollution_one(N_SA1_perth);
  vector<Type> pollution_two(N_SA1_perth);
  vector<Type> pollution_four(N_SA1_perth);
  ...
  vector<Type> pollution(N_SA1_perth);
  ...
  vector<Type> dry_cold(N_SA1_perth);
  dry_cold = dry_cold_two.array();
  
  matrix<Type> humid_hot_expanded(N_SA1_perth,N_humid_hot);
  ...
  vector<Type> humid_hot_two(N_SA1_perth);
  ...
  vector<Type> humid_hot(N_SA1_perth);
  humid_hot = humid_hot_two.array();
  
  matrix<Type> vegetation_expanded(N_SA1_perth,N_vegetation);
  ...
  vector<Type> vegetation_two(N_SA1_perth);
  ...
  REPORT(vegetation);
  REPORT(ses_effects);
  vector<Type> lstdiff_effects(N_SA1_perth);
