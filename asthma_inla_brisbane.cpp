...
Type objective_function<Type>::operator() ()
{
  ...
  matrix<Type> pollution_expanded(N_SA1_brisbane,N_pollution);
  vector<Type> buffer(N_SA1_brisbane);
  ...
  vector<Type> pollution_one(N_SA1_brisbane);
  vector<Type> pollution_two(N_SA1_brisbane);
  vector<Type> pollution_four(N_SA1_brisbane);
  ...
  vector<Type> pollution(N_SA1_brisbane);
  ...
  vector<Type> dry_cold(N_SA1_brisbane);
  dry_cold = dry_cold_two.array();
  
  matrix<Type> humid_hot_expanded(N_SA1_brisbane,N_humid_hot);
  ...
  vector<Type> humid_hot_two(N_SA1_brisbane);
  ...
  vector<Type> humid_hot(N_SA1_brisbane);
  humid_hot = humid_hot_two.array();
  
  matrix<Type> vegetation_expanded(N_SA1_brisbane,N_vegetation);
  ...
  vector<Type> vegetation_two(N_SA1_brisbane);
  ...
  REPORT(vegetation);
  REPORT(ses_effects);
  vector<Type> lstdiff_effects(N_SA1_brisbane);
